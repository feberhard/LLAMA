...
//                    userService.updateFirebaseInstanceIdToken(FirebaseInstanceId.getInstance().getToken());
    ...
    private void signOut() {
        ...
        } else if (this.isEmailPasswordUser(user)) {
            mAuth.signOut();
        }
        updateUI(null);
    }
    ...
    private boolean isGoogleUser(FirebaseUser user) {
        ...
        return user.getProviders().get(0).equals(("google.com"));
    }

    private boolean isEmailPasswordUser(FirebaseUser user) {
        return user.getProviders().get(0).equals(("password"));
    }
